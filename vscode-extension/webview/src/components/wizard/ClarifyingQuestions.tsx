...
import type { ClarifyingQuestion } from "../../vscodeApi";
            ...
            {question.options.map((opt, i) => {
              ...
              return (
                <motion.button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3.5 rounded-lg transition-all duration-200 text-left hud-card"
                  style={selected ? {
