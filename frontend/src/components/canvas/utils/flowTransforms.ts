...
/**
 * Build React Flow nodes from artifacts, groups, and connections.
 * Groups render at zIndex 0, artifacts at zIndex 1.
 * Uses dagre DAG layout when connections exist, grid layout otherwise.
 */
 ...
 * Adds arrow markers and per-type colors.
 */
